...
#TODO : create dataset from any midi file (using Joakim's code)
...
def roll_to_chroma_squeeze(roll): #reduit modulo 12 un piano roll
  res = np.zeros((12,1,1))
...
if __name__ == '__main__':
    ...
    choral_df = create_chorales_dataset(max_size=10, c_transposed=False, all_transposed=True)
    slices_train = []
    tones = []
